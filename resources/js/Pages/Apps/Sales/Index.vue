<template>
	<Head>
		<title>Report Sales - Cashier Application</title>
	</Head>
	<main class="c-main">
							...
							<div class="card-body">
								...
								<div v-if="sales">
									...
									<div class="export text-end mb-3">
										...
										<a :href="`/apps/sales/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-danger btn-md border-0 shadow me-3"><i class="fa fa-file-excel"></i>PDF</a>
									</div>
									<table class="table table-bordered">
										...
										<tbody>
											<tr v-for="sale in sales" :key="sale.id">
												...
												<td>{{ sale.customer ? sale.customer.name : 'General' }}</td>
